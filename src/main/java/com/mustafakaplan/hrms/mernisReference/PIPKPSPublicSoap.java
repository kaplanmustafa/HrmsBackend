...
public class PIPKPSPublicSoap
{
    ...
    public PIPKPSPublicSoap(){}

    public PIPKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public PIPKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        PIPExtendedSoapSerializationEnvelope envelope= new PIPExtendedSoapSerializationEnvelope(PIPExtendedSoapSerializationEnvelope.VER11);
