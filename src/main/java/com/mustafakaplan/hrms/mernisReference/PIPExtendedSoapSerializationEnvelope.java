...
public class PIPExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(PIPDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new PIPStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static PIPDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static PIPDateTimeConverter dateTimeConverter = new PIPStandardDateTimeConverter();

    public PIPExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public PIPExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new PIPMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=PIPHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,PIPExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=PIPHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
